...
void GetBgSupression(TH1D* hsg, TH1D* hbg);
...
int TMVAClassification( TString myMethodList = "" )
{
  ...
  */
  ...
  //   TFile *fsg = new TFile("/gpfs/mnt/gpfs02/phenix/spin/spin1/data77/phnxsp01/shura/emcal/sPHENIX/g.root");
  //   TFile *fbg = new TFile("/gpfs/mnt/gpfs02/phenix/spin/spin1/data77/phnxsp01/shura/emcal/sPHENIX/pi0.root");
  //   TFile *fsg = new TFile("../athena/emc/g.root"); // Produced by emc.cc
  ...
  dataloader->AddVariable( "e3", 'F' );
  dataloader->AddVariable( "e4", 'F' );
  dataloader->AddVariable( "e5", 'F' );
  dataloader->AddVariable( "e6", 'F' );
  ...
  //MY   dataloader->SetBackgroundWeightExpression( "weight" );
  ...
  //   GetBgSupression(sigEffi, bgdEffi);
